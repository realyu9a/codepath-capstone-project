...
class TaskComposeViewController: UIViewController {
    ...
    @IBAction func option(_ sender: Any) {
        ...
        case 0:
            ...
            titleField.placeholder = "Food"
            noteField.placeholder = "Calories"
        case 1:
            titleField.isHidden = true
            noteField.placeholder = "Calories Lost"
        case 2:
            titleField.isHidden = true
            noteField.placeholder = "Hours"
        default:
            break;
        }
    ...
    override func viewDidLoad() {
        ...
        if let task = taskToEdit {
            ...
            options.selectedSegmentIndex = task.option
            datePicker.date = task.dueDate

            // 2.
            self.title = "Edit Selected"
        }
    }
    ...
    @IBAction func didTapDoneButton(_ sender: Any) {
        ...
        case 0:
            ...
            guard let calorie = noteField.text,
                  !calorie.isEmpty
            else {
                presentAlert(title: "Oops...", message: "Make sure to add calories!")
                return
            }
            // 2.
            var task: Task
            ...
            if let editTask = taskToEdit {
                ...
                task.title = title
                task.note = calorie
                task.option = options.selectedSegmentIndex
                task.dueDate = datePicker.date
            } else {
                // 4.
                task = Task(title: title,
                            note: calorie,
                            option: options.selectedSegmentIndex,
        ...
        case 1:
            ...
            guard let calorie = noteField.text,
                ...
                presentAlert(title: "Oops...", message: "Make sure to add how many calories lost!")
                return
            }
        ...
        case 2:
            guard let calorie = noteField.text,
                ...
                presentAlert(title: "Oops...", message: "Make sure to add hours slept!")
                return
            }
